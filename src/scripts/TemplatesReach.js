import { checkElevation, getCharacterName, i18n, i18nFormat, isRealNumber, warn } from "./lib/lib.js";
            ...
            if (!selectedToken) {
                ...
                if (!canInteractB) {
                    ...
                    if (tokenName) {
                        ...
                        interactionFailNotification(Logger.i18n(`${CONSTANTS.MODULE_ID}.templatesNotInReach`));
                    }
                }
                return canInteractB;
            }
